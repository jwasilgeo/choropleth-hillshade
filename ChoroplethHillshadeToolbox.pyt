...
class ChoroplethHillshade(object):
    ...
    def execute(self, parameters, messages):
        ...
        def licenseCheck():
            ...
            if arcpy.CheckExtension('Spatial') == 'Available':
                ...
                arcpy.AddMessage('WARNING: This script uses geoprocessing tools that require the Spatial '
                                 'Analyst extension. It will attempt to execute with the 3D Analyst extension, '
                                 'but will not visually smoothe the final results with Focal Statistics.\n')
        ...
        try:
            ...
            where:
                H is the adjusted height value,
